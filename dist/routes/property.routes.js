...
propertyRoutes.get("/user/favorites", auth_1.authMiddleware, (req, res) => PropertyController_1.propertyController.listUserFavorites(req, res));
propertyRoutes.post("/:id/favorite", auth_1.authMiddleware, (req, res) => PropertyController_1.propertyController.addFavorite(req, res));
propertyRoutes.delete("/:id/favorite", auth_1.authMiddleware, (req, res) => PropertyController_1.propertyController.removeFavorite(req, res));
