  ...
  },
  {
    ...
    sql: `
      CREATE TABLE IF NOT EXISTS properties (
        ...
        public_code CHAR(6) NULL UNIQUE,
        ...
        area_construida_unidade VARCHAR(20) NOT NULL DEFAULT 'm2',
        area_terreno DECIMAL(12, 2) NULL,
        area_construida_valor DECIMAL(18, 4) NULL,
        area_construida_m2 DECIMAL(18, 2) NULL,
        area_terreno_valor DECIMAL(18, 4) NULL,
        area_terreno_unidade VARCHAR(20) NOT NULL DEFAULT 'm2',
        area_terreno_m2 DECIMAL(18, 2) NULL,
