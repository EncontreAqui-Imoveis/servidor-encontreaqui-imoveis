...
export async function verifyCriticalSchemaState(): Promise<SchemaVerificationSummary> {
  ...
  const requiredColumns = [
    ...
    ['users', 'email'],
    ['users', 'cpf'],
    ['users', 'cpf_ciphertext'],
    ['users', 'cpf_lookup_hash'],
    ['users', 'cpf_last4'],
    ['users', 'cpf_key_version'],
    ['users', 'firebase_uid'],
    ...
    ['privacy_requests', 'scheduled_for'],
    ['privacy_requests', 'access_revoked_at'],
    ['privacy_requests', 'processing_started_at'],
    ['privacy_requests', 'attempt_count'],
    ['privacy_requests', 'last_error_code'],
    ['brokers', 'id'],
    ['brokers', 'status'],
    ...
    ['properties', 'area_construida_valor'],
    ['properties', 'area_construida_m2'],
    ['properties', 'area_construida_unidade'],
