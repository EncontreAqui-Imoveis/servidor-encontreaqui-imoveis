...
const NegotiationRepository_1 = require("../../src/modules/negociacoes/infra/NegotiationRepository");
const NegotiationDocumentsRepository_1 = require("../../src/modules/negociacoes/infra/NegotiationDocumentsRepository");
const NegotiationContractsRepository_1 = require("../../src/modules/negociacoes/infra/NegotiationContractsRepository");
const negotiationRepo = new NegotiationRepository_1.NegotiationRepository();
const docsRepo = new NegotiationDocumentsRepository_1.NegotiationDocumentsRepository();
const contractsRepo = new NegotiationContractsRepository_1.NegotiationContractsRepository();
