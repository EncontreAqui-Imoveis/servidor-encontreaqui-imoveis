...
describe('GET /public/properties/:id', () => {
  ...
  it('loads public detail preserving original area units and derived m²', async () => {
    queryMock.mockResolvedValueOnce([
      [
        {
          id: 90122,
          title: 'Sitio Alto',
          description: 'Área agrícola',
          type: 'Sítio',
          purpose: 'Venda',
          status: 'approved',
          visibility: 'PUBLIC',
          ...
          code: 'SC-90122',
          public_code: 'SC90122',
          public_id: '123e4567-e89b-12d3-a456-426614179999',
          owner_name: null,
          owner_phone: null,
          ...
          valor_iptu: 300,
          video_url: null,
          images: 'https://cdn/field1.jpg',
          agency_id: 1,
          agency_name: 'Agência Rural',
          agency_logo_url: 'https://cdn/logo-rural.jpg',
          agency_address: 'Rua Rural',
          agency_city: 'Brasil',
          agency_state: 'GO',
          agency_phone: '6433334444',
          broker_name: 'Corretor Rural',
          broker_phone: '64988002255',
          broker_email: 'corretor-rural3@test.com',
          active_negotiation_id: null,
          active_negotiation_status: null,
          active_negotiation_value: null,
          active_negotiation_client_name: null,
    ...
    const response = await request(app).get('/public/properties/SC90122');
